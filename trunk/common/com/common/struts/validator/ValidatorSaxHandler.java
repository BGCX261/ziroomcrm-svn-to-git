...
public class ValidatorSaxHandler {
	...
	private Map saxMaps = new TreeMap();
	...
	private void addFieldValidator(Map map, Element fieldElement) {
		...
		for (int i = 0; i < size; i++) {
			Element fieldValidatorElement = (Element) fieldValidatorElements
					.get(i);
	...
	private class NoDtdEntityResolver implements EntityResolver {
		...
		public InputSource resolveEntity(String arg0, String arg1)
			...
			URL url = NoDtdEntityResolver.class.getClassLoader().getResource(
