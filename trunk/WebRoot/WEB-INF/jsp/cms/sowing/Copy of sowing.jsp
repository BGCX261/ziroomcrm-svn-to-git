						...
						<td>
							...
							<table cellpadding="0" cellspacing="1" class="tableList">
								<tr>
									...
									<td id="_houseCode" style="display:none">房源编号：<s:textfield name="vo.argumentsBeans[0].values[0]"  /></td>
									<td colspan="2"><input type="button" value="查询" onclick="searchHouse();"></td>
								</tr>
							</table>
							<table cellpadding="0" cellspacing="1" class="tableList">
								<thead>
