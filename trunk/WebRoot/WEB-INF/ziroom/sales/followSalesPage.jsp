									...
									<td width="46%" valign="middle">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[机会跟踪]</td>
											</tr>
										</table>
									</td>
									<td width="54%">
			...
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td>
							<s:form action="followSales.do" id="salesForm">
							<s:hidden name="salesVo.salesId"></s:hidden>
								...
								<tr>
									<td align="center">
										<table cellpadding="0" cellspacing="1" class="tableForm" width="80%">
											...
											<tr height="20">
												<th>客户姓名：</th>
												<td><s:textfield name="salesVo.custName" readonly="true"/></td>
												<th>联系电话：</th>
												<td><s:textfield name="salesVo.telphone" readonly="true"/></td>
												<th>机会类型：</th>
												<td>
											...
											<tr height="20">
												<th>机会名称：</th>
												<td><s:textfield name="salesVo.salesName" readonly="true"/></td>
												<th>类型：</th>
												<td><s:textfield name="salesVo.salesType" readonly="true"/></td>
												<th>来源：</th>
												<td><s:textfield name="salesVo.origin" readonly="true"/></td>
											</tr>
											<tr height="20">
												<th>阶段：</th>
