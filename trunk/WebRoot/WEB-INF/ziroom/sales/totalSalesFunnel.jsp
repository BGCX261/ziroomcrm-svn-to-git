...
<body>
	<s:hidden name="salesVo.xml" id="chartData"></s:hidden>
									...
									<td width="46%" valign="middle">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[销售漏斗]</td>
											</tr>
										</table>
									</td>
									<td width="54%">
			...
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td>
							<div id="chartContainer">加载数据</div>
							<script type="text/javascript">
							<!--
								var data = $("#chartData").val();
								var myChart = new FusionCharts( "charts/Funnel.swf", "myChartId", "400", "400", "0", "1" );
