				...
				<tr>
					<td valign="top">
						<table width="151" border="0" align="center" cellpadding="0" cellspacing="0">
							...
							<s:iterator id="v" value="menuVo.nodes">
																			...
																			<table width="95%" border="0" cellspacing="0" cellpadding="0">
																				<tr>
																					<td height="20" style="cursor: hand" onmouseover="this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#7bc4d3'; " onmouseout="this.style.borderStyle='none'">
																						<span class="STYLE3"><a href="<s:property value="#m.url"/>" target="mainFrame"><s:property value="#m.menuName"/></a></span>
																					</td>
																				</tr>
																			</table>
																		</td>
