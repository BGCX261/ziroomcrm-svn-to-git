<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <ul id="shortcut">
        <li>
            <a href="modal_window.html" id="shortcut_home" title="目前还有10套未处理的房源">
    ...
    <div class="onecolumn">
        <div class="header">
            ...
            <div class="switch" style="width:200px">
                <table width="200px" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td>
                            <input type="button" id="chart_bar" name="chart_bar" class="left_switch active" value="柱状图" style="width:50px"/>
                        </td>
                        <td>
                            <input type="button" id="chart_area" name="chart_area" class="middle_switch" value="区域图" style="width:50px"/>
                        </td>
                        <td>
                            <input type="button" id="chart_pie" name="chart_pie" class="middle_switch" value="饼图" style="width:50px"/>
                        </td>
                        <td>
                            <input type="button" id="chart_line" name="chart_line" class="right_switch" value="线型图" style="width:50px"/>
                        </td>
                    </tr>
                    </tbody>
                </table>
        ...
        <div class="content">
            ...
            <div class="alert_info">
                <p>
                    <img src="icons/icon_info.png" alt="success" class="mid_align"/>
            ...
            <form id="form_data" name="form_data" action="" method="post">
                <table class="data" width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href=""><img src="icons/icon_edit.png" alt="edit" class="help" title="Edit"/></a>
                            <a href=""><img src="icons/icon_delete.png" alt="delete" class="help" title="Delete"/></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
        ...
        <div class="column_left">
            ...
            <div class="content">
                <div class="alert_warning" style="margin-top:0">
                    <p>
                        <img src="icons/icon_warning.png" alt="success" class="mid_align"/>
                ...
                <div class="alert_success">
                    <p>
                        <img src="icons/icon_accept.png" alt="success" class="mid_align"/>
                        Success Notification.
                    </p>
                </div>
                <div class="alert_error">
                    <p>
                        <img src="icons/icon_error.png" alt="delete" class="mid_align"/>
                        Error Notification.
                    </p>
                </div>
                <br class="clear"/>
