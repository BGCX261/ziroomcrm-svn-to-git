 ...
 * @author 孙树林
 */
public class InContractVo extends ZiroomVo {
	...
	private List<InContractVo> inContractVoes = new ArrayList<InContractVo>();
	...
	public List<InContractVo> getInContractVoes() {
		return inContractVoes;
	}

	public void setInContractVoes(List<InContractVo> inContractVoes) {
		this.inContractVoes = inContractVoes;
	}
}
