package com.ziroom.module.contract.vo;
 ...
 * @author 孙树林
 */
public class OutContractVo extends ZiroomVo {
	...
	private List<OutContractVo> outContractVoes = new ArrayList<OutContractVo>();
	...
	public List<OutContractVo> getOutContractVoes() {
		return outContractVoes;
	}

	public void setOutContractVoes(List<OutContractVo> outContractVoes) {
		this.outContractVoes = outContractVoes;
	}
