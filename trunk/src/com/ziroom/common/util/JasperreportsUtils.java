...
public class JasperreportsUtils {
	...
	public static String docx(String reportFile, Map parameter, Connection conn, String tempDir) throws JRException,
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static String doc(String reportFile, Map parameter, Connection conn, String tempDir) throws JRException,
			IOException, SQLException {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static byte[] xls(String reportFile, Map parameter, Connection conn) throws JRException, IOException,
			SQLException {
		// 载入报表文件
		JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile(reportFile);
		JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, parameter, conn);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static byte[] html(String reportFile, Map parameter, Connection conn) throws JRException, IOException,
			SQLException {
		// 载入报表文件
		JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile(reportFile);
		JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, parameter, conn);
